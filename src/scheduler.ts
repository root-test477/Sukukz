...
interface ScheduledTask {
  ...
  executed: boolean;
  createdBy: number;
  botId: string; // Add botId to track which bot created the task
}
...
export function scheduleMessage(
  ...
  createdBy: number,
  botId: string = '1' // Default to '1' for backward compatibility
 ...
 */
export async function handleScheduleCommand(msg: TelegramBot.Message, botId: string = '1'): Promise<void> {
