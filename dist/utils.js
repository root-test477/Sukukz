...
function isAdmin(chatId, botId) {
    ...
    const legacyAdminIds = ((_a = process.env.ADMIN_IDS) === null || _a === void 0 ? void 0 : _a.split(',').map(id => Number(id.trim()))) || [];
...
function buildUniversalKeyboard(link, wallets, botId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (botId) {
            ...
            if (botConfig === null || botConfig === void 0 ? void 0 : botConfig.link) {
