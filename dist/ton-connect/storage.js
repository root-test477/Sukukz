...
function updateUserActivity(chatId, botId, transactionAmount) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const allUsersData = yield client.hGet('all_users', userKey);
        if (allUsersData) {
...
function saveTransactionSubmission(chatId, botId, transactionId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield client.hSet('transaction_submissions', submissionId, JSON.stringify(submission));
        if (DEBUG) {
...
function updateTransactionStatus(transactionId, botId, status, adminId, notes) {
    return __awaiter(this, void 0, void 0, function* () {
        const submissionId = `${transactionId}:${botId}`;
        const data = yield client.hGet('transaction_submissions', submissionId);
        if (!data)
            return null;
