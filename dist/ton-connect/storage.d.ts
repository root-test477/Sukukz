...
export declare const getSupportMessages: typeof getSupportMessagesForUser;
/**
 ...
 */
export declare function getTutorialState(chatId: number): Promise<TutorialState | null>;
/**
 ...
 */
export declare function saveTransaction(userId: number, transactionId: string, amount?: string, description?: string): Promise<void>;
/**
 * Get a transaction by ID
 * @param transactionId Transaction ID
 */
export declare function getTransaction(transactionId: string): Promise<TransactionSubmission | null>;
/**
 * Update a transaction
 * @param transactionId Transaction ID
 * @param updates Fields to update
 */
export declare function updateTransaction(transactionId: string, updates: Partial<TransactionSubmission>): Promise<TransactionSubmission | null>;
/**
 * Save error report
 * @param error Error report
 */
export declare function saveErrorReport(error: ErrorReport): Promise<void>;
/**
