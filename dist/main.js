...
import { handleConnectCommand, handleDisconnectCommand, handleShowMyWalletCommand, handleSendTXCommand, handleFundingCommand, handleUsersCommand, handleInfoCommand, handleSupportCommand, handlePayNowCommand, handleApproveCommand, handleRejectCommand, handleWithdrawCommand, handleBackToMenuCallback } from "./commands-handlers";
...
async function main()
    ...
    bot.on('callback_query', async query => {
        ...
        let request: { method data: string };
    ...
    if (isWebhook && botId && req.method === 'POST') {
        ...
        req.on('end', () => {
            try {
                ...
                res.writeHead(success ? 200  { 'Content-Type': 'application/json' });
