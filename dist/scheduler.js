...
function notifyAdmin(adminId, message) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield (0, error_boundary_1.safeSendMessage)(adminId, message);
        }
        catch (error) {
 ...
 */
function handleScheduleCommand(msg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (commandArgs.length === 0) {
            yield (0, error_boundary_1.safeSendMessage)(chatId, "⚠️ Please provide a message to send");
            return;
        }
        ...
        confirmationMsg += `\n📝 Message:\n${message}`;
        yield (0, error_boundary_1.safeSendMessage)(chatId, confirmationMsg, { parse_mode: 'Markdown' });
    });
}
