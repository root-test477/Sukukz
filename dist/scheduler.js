 ...
 */
function parseTimeString(timeStr | null
...
export function scheduleMessage(
  ...
  createdBy: { taskId executionTime: Date } {
  const now = Date.now();
 ...
 */
export async function handleScheduleCommand(msg: TelegramBot.Message)
  ...
  let specificUserId | undefined undefined;
