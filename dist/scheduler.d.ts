 ...
 */
export declare function scheduleMessage(delay: number, targetUsers: 'specific' | 'all' | 'active' | 'inactive', message: string, specificUserId: number | undefined, createdBy: number): {
    taskId: string;
    executionTime: Date;
};
/**
 ...
 */
export declare function handleScheduleCommand(msg: TelegramBot.Message): Promise<void>;
